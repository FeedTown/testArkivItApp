...
public class DocumentConverter {
	...
	public DocumentConverter(ArrayList<File> convertedFiles) {
	...
	public ArrayList<File> traverse(ArrayList<File> fileDirectory) {
			...
			if(fileDirectory.get(i).isFile()) {
				...
				try 
				{
					...
					{ 
						...
						//File f = new File(removeBeginningOfPath);
	...
	public ArrayList<File> testMethod2(ArrayList<File> file) {
	...
	public List<File> getTestEntries() {
		return testEntries;
	}

	public void setTestEntries(List<File> testEntries) {
