...
public class OriginalDocCon {
    ...
    static void traverse( File fileDirectory ) {
        ...
        File outdir = new File(OriginalDocCon.sOutputDir);
        ...
        for ( int i = 0; i < entries.length; ++i ) {
            ...
            if ( entries[ i ].isDirectory() ) {
                ...
                try {
                    ...
                    Object oDocToStore =
                    		OriginalDocCon.xCompLoader.loadComponentFromURL(
                    ...
                    propertyValues[1].Value = OriginalDocCon.sConvertType;
