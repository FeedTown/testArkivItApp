...
public class MetadataToExcelGUI{
	...
	private boolean checkIfCurrentFileOrDirContainsIllegalChars(File currFileOrDir) {
		if(currFileOrDir.getName().contains("�") || currFileOrDir.getName().contains("�") || currFileOrDir.getName().contains("�")
				|| currFileOrDir.getName().contains("�") || currFileOrDir.getName().contains("�") || currFileOrDir.getName().contains("�") 
				|| currFileOrDir.getName().contains("�") || currFileOrDir.getName().contains("�"))
		{
			return true;
		}
		else
